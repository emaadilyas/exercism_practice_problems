...
namespace estate_executor {
    int assemble_account_number(int secret_modifier) {
        int masterNumber{zhang::bank_number_part(secret_modifier) + khan::bank_number_part(secret_modifier) + garcia::bank_number_part(secret_modifier)};
        return masterNumber;
    }
            int assemble_code() {
                int totalBlue = zhang::blue::code_fragment() + khan::blue::code_fragment() +         garcia::blue::code_fragment();
                int totalRed = zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment();
